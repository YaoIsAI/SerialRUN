...
| macOS (Apple Silicon) | [SerialRUN-v0.1.0-macos-arm64.zip](https://github.com/YaoIsAI/SerialRUN/releases/download/v0.1.0/serialrun-0.1.0-macos-arm64.zip) (v0.2.0 即将发布) |
